...
/// DEPRECATED: This module is pending migration to dag/.
/// It was moved here from common/ during the M0 cleanup because it depends on
/// dag-specific types (Target, TargetRegistry) that don't belong in common/.
/// This module will be consolidated with dag registry/target functionality in a future cleanup.
