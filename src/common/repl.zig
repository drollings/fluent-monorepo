...
/// Initializes a Zig executable with provided allocator and context, returning the compiled Repl.
...
/// Processes a Zig code string and returns a compiled Zig module.
