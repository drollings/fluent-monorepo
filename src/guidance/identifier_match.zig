...
/// Manages identifier matching with a fixed enum; owned by the module; ensures consistent key definitions.
...
/// Tracks identifier matches in Zig code; manages ownership and invariants for correct usage.
